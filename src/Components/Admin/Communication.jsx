              ...
              <div key={index} className='flex justify-between rounded-lg p-4 mb-4 bg-slate-100 hover:bg-slate-200 '>
                ...
                <div className='px-1 flex  '>
                    ...
                    <button
                      ...
                      className="bg-gray-300 hover:bg-red-400 text-sm text-black font-bold py-1 px-2 rounded h-fit"
                    >
              ...
              <div >
                {replyBtn && selectedMessage && (
                  <div className='mt-2 shadow-md rounded-lg px-8 py-6'>
                    ...
                    <div className='ml-4'>
                      <p className=' font-bold text-slate-500'>@{adminData.name}</p>
